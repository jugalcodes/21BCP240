...
//MIDDLEWARE
app.use(cors({ origin: '*',  methods: 'GET, POST, PUT, DELETE', credentials: true})) // here as our server is running on different local add and frontend on different so this cross origin allows frontend to access server from any port number
