...
//MIDDLEWARE
app.use(cors({ origin: 'https://21-bcp-240-front.vercel.app/',  methods: 'GET, POST, PUT, DELETE', credentials: true})) // here as our server is running on different local add and frontend on different so this cross origin allows frontend to access server from any port number
